...
export default function Welcome() {
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#F4F6F9] font-['Inter',sans-serif] selection:bg-[#39A900] selection:text-white">
            ...
            {/* Top Branding */}
            <div className="absolute top-0 left-0 right-0 p-6 md:p-10 lg:p-12 z-20 flex justify-between items-center pointer-events-none">
                <motion.div 
                    initial={{ y: -20, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ delay: 0.2 }}
                    className="flex items-center gap-3 md:gap-4 bg-white/10 backdrop-blur-md px-4 py-2 md:px-6 md:py-3 rounded-2xl border border-white/20 shadow-lg pointer-events-auto">
                    <img src="/logo-ape.png" alt="SENA APE" className="h-8 md:h-10 lg:h-12 object-contain drop-shadow-md brightness-0 invert" />
                    <div className="border-l border-white/30 pl-3 md:pl-4">
                        <p className="text-white font-black text-[10px] md:text-xs tracking-widest uppercase">Servicio Público</p>
                        <p className="text-gray-300 text-[8px] md:text-[10px] tracking-wider">de Empleo</p>
                    </div>
                </motion.div>
            ...
            <main className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center">
                <div className="max-w-5xl space-y-10">
                    ...
                    <motion.div 
                        ...
                        <h1 className="font-black text-[clamp(2.5rem,8vw,7.5rem)] text-white leading-[0.95] tracking-tight drop-shadow-2xl">
                            Bienvenido al <br/>
                        ...
                        <p className="text-[clamp(1rem,2vw,1.8rem)] text-gray-200 max-w-3xl mx-auto leading-relaxed font-medium drop-shadow-lg [text-shadow:_0_2px_10px_rgb(0_0_0_/_60%)]">
                    ...
                    <motion.div 
                        ...
                        <a 
                            href="/seleccion" 
                            className="group relative z-50 inline-flex items-center justify-center px-10 md:px-14 py-6 md:py-8 bg-gradient-to-b from-[#39A900] to-[#266e00] hover:from-[#43c400] hover:to-[#2e8500] text-white rounded-3xl shadow-[0_20px_50px_rgba(57,169,0,0.5)] active:shadow-none active:scale-95 transition-all duration-200 overflow-hidden touch-manipulation border border-[#5ceb00]/30 cursor-pointer">
                            ...
                            <span className="relative font-black text-2xl md:text-[clamp(1.8rem,4vw,3.5rem)] tracking-wide flex items-center gap-4 md:gap-6 pointer-events-none">
                                Empezar ahora
                                <div className="bg-white/20 p-2 rounded-full group-hover:translate-x-3 transition-transform duration-300">
                                    <ChevronRight className="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-white" strokeWidth={3} />
                                </div>
                            </span>
                        </a>
