...
const initialQueue = [
    ...
    { id: 't-044', turn: 'N-044', doc: '1.085.987.123', timeWait: '20 minutos', type: 'Empresa', typeColor: 'bg-blue-700', service: 'Empresa: "Inversiones del Caribe"' },
...
export default function Dashboard({ auth }) {
    ...
    const disableFinalizar = !activeTurn || showSuccessAnim; // Habilitado siempre que haya turno activo, y el boton de finalizar marcará el cierre automáticamente
